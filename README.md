...
它不仅仅是定时发消息，它会**看群聊气氛**、**选时间段发合适的内容**、甚至会**根据心情发语音和自拍**，并且**记得自己发过什么**。
...
*   **自然追问**：
    *   *Bot 分享了一张自拍。*
    *   *用户回复*：“你这件衣服哪里买的？”
    *   *Bot (能读取到配图描述)*：“哈哈，这是我新买的米色毛衣，在市中心逛街看到的...”
...
| 插件名称 | 必需性 | 作用 | 缺失影响 |
| :--- | :--- | :--- | :--- |
| **astrbot_plugin_life_scheduler[<sup>url</sup>](https://github.com/siciyuanweilai/astrbot_plugin_life_scheduler)** | ⭐⭐⭐⭐⭐ | 提供虚拟生活、天气、穿搭 | 分享内容缺少生活细节，配图无法固定穿搭 |
...
| **astrbot_plugin_gitee_aiimg[<sup>url</sup>](https://github.com/siciyuanweilai/astrbot_plugin_gitee_aiimg)** | ⭐⭐⭐⭐ | 提供 AI 绘图能力 | 无法发送配图 |
...
**Q: 我问 Bot 刚才发的图片里有什么，它为什么能回答上来？**
> A: 因为插件启用了 **上下文回写** 功能。当 Bot 生成图片时，插件会将生成图片的 Prompt（如“少女，猫耳，咖啡厅”）记录在对话历史中。对 LLM 来说，它虽然看不见图，但它“读”到了图片的详细描述。
